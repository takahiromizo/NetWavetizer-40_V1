...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L gig_ethernet_pcs_pma_v16_2_13 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot gig_ethernet_pcs_pma xil_defaultlib.gig_ethernet_pcs_pma xil_defaultlib.glbl -log elaborate.log
}
