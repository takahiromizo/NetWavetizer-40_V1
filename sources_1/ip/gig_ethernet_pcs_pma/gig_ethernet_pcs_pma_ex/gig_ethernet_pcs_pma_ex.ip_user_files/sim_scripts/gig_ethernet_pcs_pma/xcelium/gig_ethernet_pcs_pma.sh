...
#
# Script generated by Vivado on Mon Jan 01 23:20:17 JST 2024
...
design_libs_elab="-libname xpm -libname gig_ethernet_pcs_pma_v16_2_13 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm gig_ethernet_pcs_pma_v16_2_13 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "gig_ethernet_pcs_pma.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
compile()
{
  ...
  xmvhdl -work gig_ethernet_pcs_pma_v16_2_13 -V93 $xmvhdl_opts \
  "../../../ipstatic/hdl/gig_ethernet_pcs_pma_v16_2_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvlog -work gig_ethernet_pcs_pma_v16_2_13 $xmvlog_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.gig_ethernet_pcs_pma xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.gig_ethernet_pcs_pma -input simulate.do
}
