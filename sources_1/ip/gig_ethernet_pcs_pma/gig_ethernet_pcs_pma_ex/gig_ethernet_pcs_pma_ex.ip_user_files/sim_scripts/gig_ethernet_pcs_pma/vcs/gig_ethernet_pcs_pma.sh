...
design_libs=(xpm gig_ethernet_pcs_pma_v16_2_13 xil_defaultlib)
...
compile()
{
  ...
  vhdlan -work gig_ethernet_pcs_pma_v16_2_13 $vhdlan_opts \
  "../../../ipstatic/hdl/gig_ethernet_pcs_pma_v16_2_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vhdlan.log 2>/dev/null

  vlogan -work gig_ethernet_pcs_pma_v16_2_13 $vlogan_opts +v2k \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.gig_ethernet_pcs_pma xil_defaultlib.glbl -o gig_ethernet_pcs_pma_simv
}
